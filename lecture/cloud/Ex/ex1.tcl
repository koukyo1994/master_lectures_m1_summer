...
$tcp1 set class_ 2 
$tcp1 set interval_ 0.05
$tcp1 set packetSize_ 1000
$ns attach-agent $s0 $tcp1

set sink1 [new Agent/TCPSink]
$ns attach-agent $r0 $sink1
...
$ns at 51.0 "$ftp1 start;
$ns trace-annotate \"Time:[$ns now] Start CBR interval [$tcp1 set interval_] size [$tcp1 set packetSize_]\""
$ns at 101.0 "$ftp1 stop; $ns trace-annotate \"Time:[$ns now] Stop CBR\""
